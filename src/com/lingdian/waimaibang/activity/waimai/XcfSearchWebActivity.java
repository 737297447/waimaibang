...
public class XcfSearchWebActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.waimai_fragment_xiachufang);
		findViewById();
		setListener();
		init();
	}
	...
	protected void init() {
		...
		title_bar_text.setText(name+"");
		webView.loadUrl("http://m.xiachufang.com/search/?keyword="+name);
	}
