...
public class MeituanActivity extends BaseActivity implements OnClickListener {
	...
	protected void init() {
		...
		geocode = SharedpreferncesUtil.getGeoceode(this);
		if (!TextUtils.isEmpty(geocode)) {
			webUrl = "http://i.waimai.meituan.com/home/" + geocode;
